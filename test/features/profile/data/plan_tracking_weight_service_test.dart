...
void main() {
  ...
  group('PlanTrackingCalculator', () {
    ...
    test('keeps initial goal projection before day 14 even with three entries', () {
      final result = calculator.calculateGoalProjection(
        weightEntryCount: 3,
        observationDays: 13,
        planStartWeight: 80,
        targetWeight: 75,
        ...
        planActivatedAt: DateTime(2026, 8, 1),
        latestWeight: 77.5,
        latestWeightDate: DateTime(2026, 8, 13),
        actualWeeklyWeightChangeKg: -1,
      );
      ...
      expect(
        result.projectionDifferenceDays,
        isNull,
      );
    });

    test('updates cached goal projection on day 14 without a new weight entry', () {
      final result = calculator.calculateGoalProjection(
        weightEntryCount: 3,
        observationDays: 14,
        planStartWeight: 80,
